...
![hosts1](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/hosts1.png)
![hosts2](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/hosts2.png)
![hosts3](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/hosts3.png)
...
![sidecar1](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/sidecar1.png)
![sidecar2](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/sidecar2.png)
...
![frontpage](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/frontpage.png)
![email](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/email.png)

我用360大家见谅哈~（尴尬：我注册时不是这样啊？？？）  
不管怎么样了，现在你登录Github，（如果需要验证码就登录一下）大概是这个样子的：  

![myPage](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/myPage.png)

### 2.2 创建一个仓库
为了储存我们的代码，我们需要分配给他一个空间，学名 repository ，意思是仓库。  
如图，点击右上角的 New 按钮，然后会弹出如下界面。

![create1](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/create1.png)
![create2](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/create2.png)

我们如图勾选，


![create3](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/create3.png)
...
![repo2](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/repo2.png)
...
![settings2](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/settings2.png)

把 Source 调成你现有的分支，点击 Save 。  

![settings3](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/settings3.png)


### 3.2 编辑主页
现在你访问你的网站，大概是这样的：

![your1](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/your1.png)
...
![change1](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/change1.png)

为了githubpages更好的识别你的主页，我们需要更名README。点击那支笔，进入如下界面。

![change2](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/change2.png)

红框框内的命称是文件名。我们把他改成 index.md

![change3](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/change3.png)
...
![theme1](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/theme1.png)

我选了一个Cayman。

![theme2](https://guleixibian2009.github.io/Sourse/Pics/Code/Github/01/theme2.png)
